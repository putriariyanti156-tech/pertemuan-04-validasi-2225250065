...
Dokumentasi resmi Python dan bahan ajar Pertemuan 04 digunakan sebagai referensi dalam memahami struktur `if-elif-else`, validasi input, dan `try-except ValueError`.